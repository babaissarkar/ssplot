...
public class SystemData {
	...
	public String[] eqns;
	public double[] max, min, gap; // The range
	public int n = 1000; /* iteration count */
	public double h = 0.05; /* stepsize for RK4 */
	
	private int dim = 3;
	private ScriptEngine engine;
	private String engineName;
	private TreeParser parser;
	private TreeNode[] eqnNodes;
	private boolean usingInternalParser;
